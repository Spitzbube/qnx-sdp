...
#endif
#ifdef GENERATOR_FILE
extern int ix86_indirect_branch_thunk_register;
#else
  int x_ix86_indirect_branch_thunk_register;
#define ix86_indirect_branch_thunk_register global_options.x_ix86_indirect_branch_thunk_register
#endif
#ifdef GENERATOR_FILE
...
enum opt_code
{
  ...
  OPT_mfunction_return_ = 1197,              /* -mfunction-return= */
  ...
  OPT_mindirect_branch_register = 1204,      /* -mindirect-branch-register */
  OPT_mindirect_branch_ = 1205,              /* -mindirect-branch= */
  OPT_minline_all_stringops = 1206,          /* -minline-all-stringops */
  OPT_minline_stringops_dynamically = 1207,  /* -minline-stringops-dynamically */
  /* OPT_mintel_syntax = 1208, */            /* -mintel-syntax */
  OPT_mlarge_data_threshold_ = 1209,         /* -mlarge-data-threshold= */
  OPT_mlong_double_128 = 1210,               /* -mlong-double-128 */
  OPT_mlong_double_64 = 1211,                /* -mlong-double-64 */
  OPT_mlong_double_80 = 1212,                /* -mlong-double-80 */
  OPT_mlwp = 1213,                           /* -mlwp */
  OPT_mlzcnt = 1214,                         /* -mlzcnt */
  OPT_mmemcpy_strategy_ = 1215,              /* -mmemcpy-strategy= */
  OPT_mmemset_strategy_ = 1216,              /* -mmemset-strategy= */
  OPT_mmmx = 1217,                           /* -mmmx */
  OPT_mmovbe = 1218,                         /* -mmovbe */
  OPT_mmpx = 1219,                           /* -mmpx */
  OPT_mms_bitfields = 1220,                  /* -mms-bitfields */
  OPT_mmwaitx = 1221,                        /* -mmwaitx */
  OPT_mno_align_stringops = 1222,            /* -mno-align-stringops */
  OPT_mno_default = 1223,                    /* -mno-default */
  OPT_mno_fancy_math_387 = 1224,             /* -mno-fancy-math-387 */
  OPT_mno_push_args = 1225,                  /* -mno-push-args */
  OPT_mno_red_zone = 1226,                   /* -mno-red-zone */
  OPT_mno_sse4 = 1227,                       /* -mno-sse4 */
  OPT_mnop_mcount = 1228,                    /* -mnop-mcount */
  OPT_momit_leaf_frame_pointer = 1229,       /* -momit-leaf-frame-pointer */
  OPT_mpc32 = 1230,                          /* -mpc32 */
  OPT_mpc64 = 1231,                          /* -mpc64 */
  OPT_mpc80 = 1232,                          /* -mpc80 */
  OPT_mpclmul = 1233,                        /* -mpclmul */
  OPT_mpcommit = 1234,                       /* -mpcommit */
  ...
  OPT_mtbm = 1269,                           /* -mtbm */
  OPT_mtls_dialect_ = 1270,                  /* -mtls-dialect= */
  OPT_mtls_direct_seg_refs = 1271,           /* -mtls-direct-seg-refs */
  OPT_mtune_ctrl_ = 1272,                    /* -mtune-ctrl= */
  OPT_mtune_ = 1273,                         /* -mtune= */
  ...
  OPT_nocpp = 1287,                          /* -nocpp */
  OPT_nodefaultlibs = 1288,                  /* -nodefaultlibs */
  /* OPT_nopie = 1289, */                    /* -nopie */
  ...
  OPT_pie = 1300,                            /* -pie */
  OPT_pipe = 1301,                           /* -pipe */
  OPT_posix = 1302,                          /* -posix */
  OPT_print_file_name_ = 1303,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1304,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1305,          /* -print-multi-directory */
  OPT_print_multi_lib = 1306,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1307,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1308,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1309,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1310,               /* -print-prog-name= */
  OPT_print_search_dirs = 1311,              /* -print-search-dirs */
  OPT_print_sysroot = 1312,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1313,   /* -print-sysroot-headers-suffix */
  OPT_pthread = 1314,                        /* -pthread */
  OPT_quiet = 1315,                          /* -quiet */
  OPT_r = 1316,                              /* -r */
  OPT_rdynamic = 1317,                       /* -rdynamic */
  OPT_remap = 1318,                          /* -remap */
  OPT_rpath_link = 1319,                     /* -rpath-link */
  OPT_rpath_link_ = 1320,                    /* -rpath-link= */
  OPT_rpath_ = 1321,                         /* -rpath= */
  OPT_s = 1322,                              /* -s */
  ...
  OPT_stdlib_libc__ = 1381,                  /* -stdlib=libc++ */
  OPT_stdlib_libcpp = 1382,                  /* -stdlib=libcpp */
  OPT_stdlib_libcpp_ne = 1383,               /* -stdlib=libcpp-ne */
  OPT_stdlib_libstdc__ = 1384,               /* -stdlib=libstdc++ */
  OPT_symbolic = 1385,                       /* -symbolic */
  OPT_t = 1386,                              /* -t */
  OPT_time = 1387,                           /* -time */
  OPT_time_ = 1388,                          /* -time= */
  OPT_traditional = 1389,                    /* -traditional */
  OPT_traditional_cpp = 1390,                /* -traditional-cpp */
  OPT_trigraphs = 1391,                      /* -trigraphs */
  OPT_u = 1392,                              /* -u */
  OPT_undef = 1393,                          /* -undef */
  OPT_v = 1394,                              /* -v */
  OPT_version = 1395,                        /* -version */
  OPT_w = 1396,                              /* -w */
  OPT_wrapper = 1397,                        /* -wrapper */
  OPT_x = 1398,                              /* -x */
  OPT_z = 1399,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
