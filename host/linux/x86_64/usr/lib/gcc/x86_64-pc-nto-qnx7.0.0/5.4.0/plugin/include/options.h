...
enum opt_code
{
  ...
  OPT_mfunction_return_ = 1195,              /* -mfunction-return= */
  ...
  OPT_mindirect_branch_register = 1202,      /* -mindirect-branch-register */
  OPT_mindirect_branch_ = 1203,              /* -mindirect-branch= */
  ...
  OPT_rpath_link = 1317,                     /* -rpath-link */
  OPT_rpath_link_ = 1318,                    /* -rpath-link= */
  OPT_rpath_ = 1319,                         /* -rpath= */
  OPT_s = 1320,                              /* -s */
  OPT_s_bc_abi = 1321,                       /* -s-bc-abi */
  OPT_save_temps = 1322,                     /* -save-temps */
  OPT_save_temps_ = 1323,                    /* -save-temps= */
  OPT_shared = 1324,                         /* -shared */
  OPT_shared_libgcc = 1325,                  /* -shared-libgcc */
  /* OPT_specs = 1326, */                    /* -specs */
  OPT_specs_ = 1327,                         /* -specs= */
  OPT_static = 1328,                         /* -static */
  OPT_static_libasan = 1329,                 /* -static-libasan */
  OPT_static_libgcc = 1330,                  /* -static-libgcc */
  OPT_static_libgcj = 1331,                  /* -static-libgcj */
  OPT_static_libgfortran = 1332,             /* -static-libgfortran */
  OPT_static_libgo = 1333,                   /* -static-libgo */
  OPT_static_liblsan = 1334,                 /* -static-liblsan */
  OPT_static_libmpx = 1335,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1336,          /* -static-libmpxwrappers */
  OPT_static_libstdc__ = 1337,               /* -static-libstdc++ */
  OPT_static_libtsan = 1338,                 /* -static-libtsan */
  OPT_static_libubsan = 1339,                /* -static-libubsan */
  /* OPT_std_c__03 = 1340, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1341, */                /* -std=c++0x */
  OPT_std_c__11 = 1342,                      /* -std=c++11 */
  OPT_std_c__14 = 1343,                      /* -std=c++14 */
  /* OPT_std_c__17 = 1344, */                /* -std=c++17 */
  /* OPT_std_c__1y = 1345, */                /* -std=c++1y */
  OPT_std_c__1z = 1346,                      /* -std=c++1z */
  OPT_std_c__98 = 1347,                      /* -std=c++98 */
  OPT_std_c11 = 1348,                        /* -std=c11 */
  /* OPT_std_c1x = 1349, */                  /* -std=c1x */
  /* OPT_std_c89 = 1350, */                  /* -std=c89 */
  OPT_std_c90 = 1351,                        /* -std=c90 */
  OPT_std_c99 = 1352,                        /* -std=c99 */
  /* OPT_std_c9x = 1353, */                  /* -std=c9x */
  OPT_std_f2003 = 1354,                      /* -std=f2003 */
  OPT_std_f2008 = 1355,                      /* -std=f2008 */
  OPT_std_f2008ts = 1356,                    /* -std=f2008ts */
  OPT_std_f95 = 1357,                        /* -std=f95 */
  OPT_std_gnu = 1358,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1359, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1360, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1361,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 1362,                    /* -std=gnu++14 */
  /* OPT_std_gnu__17 = 1363, */              /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 1364, */              /* -std=gnu++1y */
  OPT_std_gnu__1z = 1365,                    /* -std=gnu++1z */
  ...
  OPT_stdlib_libc__ = 1379,                  /* -stdlib=libc++ */
  OPT_stdlib_libcpp = 1380,                  /* -stdlib=libcpp */
  OPT_stdlib_libcpp_ne = 1381,               /* -stdlib=libcpp-ne */
  OPT_stdlib_libstdc__ = 1382,               /* -stdlib=libstdc++ */
