...
typedef int32_t (ado_mixer_delement_control_balance1_t)(MIXER_CONTEXT_T *context, ado_mixer_delement_t *element, uint8_t set, uint32_t *val, void *instance_data);
...
ado_mixer_delement_t * ado_mixer_element_balance1 (ado_mixer_t * mixer, char *name, struct snd_mixer_element_balance1_range range, uint32_t chn_mask, ado_mixer_delement_control_balance1_t * control, void *instance_data, void (*instance_free) (void *data));
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.0.0/BC700_6762_sdp704/services/audio/public/include/ado_mixer.h $ $Rev: 885778 $")
#endif
