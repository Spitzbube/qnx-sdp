...
typedef struct ado_mixer_devent_pulse	ado_mixer_devent_pulse_t;
...
typedef int32_t (ado_mixer_delement_control_balance1_t)(MIXER_CONTEXT_T *context, ado_mixer_delement_t *element, uint8_t set, uint32_t *val, const snd_pcm_chmap_t *chmap, void *instance_data);
...
ado_card_t *ado_mixer_get_card( ado_mixer_t *mixer );
...
void ado_mixer_element_set_transitory ( ado_mixer_delement_t *delement, int state );
int32_t ado_mixer_create ( ado_card_t *card , char *id , ado_mixer_t **rmixer , MIXER_CONTEXT_T *context );
ado_mixer_dgroup_t * ado_mixer_group_create (ado_mixer_t * mixer, char *name, const snd_pcm_chmap_t *chmap, ado_mixer_delement_t * vol_elem, ado_mixer_delement_t * mute_elem, ado_mixer_delement_t * cap_elem, ado_mixer_delement_t * mux_in_elem);
ado_mixer_dgroup_t *ado_mixer_playback_group_create ( ado_mixer_t *mixer, char *name, const snd_pcm_chmap_t *chmap, ado_mixer_delement_t *vol_elem, ado_mixer_delement_t *mute_elem );
ado_mixer_dgroup_t *ado_mixer_capture_group_create ( ado_mixer_t *mixer, char *name, const snd_pcm_chmap_t *chmap, ado_mixer_delement_t *vol_elem, ado_mixer_delement_t *mute_elem, ado_mixer_delement_t *cap_elem, ado_mixer_delement_t *mux_in_elem );
void ado_mixer_group_destroy ( ado_mixer_t *mixer , ado_mixer_dgroup_t *dgroup );
int32_t ado_mixer_group_balance_add (ado_mixer_t *mixer, ado_mixer_dgroup_t *group, ado_mixer_delement_t *balance_elem);
...
ado_mixer_delement_t *ado_mixer_element_io ( ado_mixer_t *mixer , char *name , int32_t type , uint32_t attrib , const snd_pcm_chmap_t *chmap);
...
ado_mixer_delement_t *ado_mixer_element_sw3 ( ado_mixer_t *mixer , char *name , uint32_t type , const snd_pcm_chmap_t *chmap , ado_mixer_delement_control_sw3_t *control , void *instance_data , void (*instance_free )(void *data ));
...
ado_mixer_delement_t * ado_mixer_element_balance1 (ado_mixer_t * mixer, char *name, struct snd_mixer_element_balance1_range range, const snd_pcm_chmap_t *chmap, ado_mixer_delement_control_balance1_t * control, void *instance_data, void (*instance_free) (void *data));
...
int ado_mixer_get_element_type (ado_mixer_delement_t *element);


void version (int *major, int *minor, const char **date);
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.1.0/trunk/services/audio/public/include/ado_mixer.h $ $Rev: 895361 $")
#endif
