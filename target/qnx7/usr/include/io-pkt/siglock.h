...
#define NW_INTR_LK(ihp) (stk_ctl.drop_priv) ? pthread_mutex_lock(&(ihp)->mtx) : InterruptLock(&(ihp)->spin)
#define NW_INTR_UNLK(ihp) (stk_ctl.drop_priv) ? pthread_mutex_unlock(&(ihp)->mtx) : InterruptUnlock(&(ihp)->spin)
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.1.0/trunk/lib/io-pkt/sys/siglock.h $ $Rev: 898560 $")
#endif
