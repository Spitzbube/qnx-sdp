...
#define WT_COREFLAGS	WT_CORE | WT_IRUPT | WT_FLOW | WT_BRIDGE
	...
	unsigned int		  thread_rand; /* per-nw_thread random context */
	int			  unused[3];
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.1.0/trunk/lib/io-pkt/sys/nw_datastruct.h $ $Rev: 898560 $")
#endif
