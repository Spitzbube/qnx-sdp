...
#define _IOPKT_SYM_GET_1(N, _2, ...) N
#define _IOPKT_SYM_GET_2(_1, N, ...) N

#define IOPKT_LSM_ENTRY_SYM_INIT(entry)		{IOPKT_VERSION, IOPKT_MODULE_TYPE, (entry)}
#define IOPKT_DRVR_ENTRY_SYM_INIT(...)		{IOPKT_VERSION,							                                \
						(_IOPKT_SYM_GET_2(__VA_ARGS__, 0) > 0) ? _IOPKT_SYM_GET_2(__VA_ARGS__, 0) : IOPKT_MODULE_TYPE,	\
						_IOPKT_SYM_GET_1(__VA_ARGS__, 0)}

#endif

#if defined(__QNXNTO__) && defined(__USESRCVERSION)
#include <sys/srcversion.h>
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.1.0/trunk/lib/io-pkt/sys/sys/io-pkt.h $ $Rev: 898560 $")
#endif
