...
uint32_t viod_get_pci_bdf(const struct viod *const vdp);
...
int viod_needs_reset(const struct viod *vdp);
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.1.0/trunk/lib/hyp/public/virtio_drvr.h $ $Rev: 891053 $")
#endif
