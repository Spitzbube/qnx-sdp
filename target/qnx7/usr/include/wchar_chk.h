...
extern __FORTIFY_FUNCTION wchar_t * wcscpy(wchar_t * _Restrict __ws1, const wchar_t * _Restrict __ws2) {
  if (__bos(__ws1) != (size_t) -1)
    return __wcscpy_chk(__ws1, __ws2, __bos(__ws1) / sizeof(wchar_t));
  return __wcscpy_alias(__ws1, __ws2);
}

extern __FORTIFY_FUNCTION wchar_t * wcsncpy(wchar_t * _Restrict __ws1, const wchar_t * _Restrict __ws2, size_t __n) {
  if (__bos(__ws1) != (size_t) -1)
    return __wcsncpy_chk (__ws1, __ws2, __n, __bos(__ws1) / sizeof(wchar_t));
  return __wcsncpy_alias(__ws1, __ws2, __n);
}

extern __FORTIFY_FUNCTION wchar_t * wcscat(wchar_t * _Restrict __ws1, const wchar_t * _Restrict __ws2) {
  if (__bos(__ws1) != (size_t) -1)
    return __wcscat_chk(__ws1, __ws2, __bos(__ws1) / sizeof(wchar_t));
  return __wcscat_alias(__ws1, __ws2);
}

extern __FORTIFY_FUNCTION wchar_t * wcsncat(wchar_t * _Restrict __ws1, const wchar_t * _Restrict __ws2, size_t __n) {
  if (__bos(__ws1) != (size_t) -1)
    return __wcsncat_chk(__ws1, __ws2, __n, __bos(__ws1) / sizeof(wchar_t));
  return __wcsncat_alias(__ws1, __ws2, __n);
}

extern __FORTIFY_FUNCTION wchar_t * wmemcpy(wchar_t * _Restrict __ws1, const wchar_t * _Restrict __ws2, size_t __n) {
...
extern __FORTIFY_FUNCTION wchar_t * wmemmove(wchar_t * _Restrict __ws1, const wchar_t * _Restrict __ws2, size_t __n) {
  if (__bos0(__ws1) != (size_t) -1)
    return __wmemmove_chk(__ws1, __ws2, __n, __bos0(__ws1) / sizeof(wchar_t));
  return __wmemmove_alias(__ws1, __ws2, __n);
}

extern __FORTIFY_FUNCTION wchar_t * wmemset(wchar_t * __ws, wchar_t __wc, size_t __n) {
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.1.0/trunk/lib/c/public/wchar_chk.h $ $Rev: 866440 $")
#endif
