...
#ifdef __EXT_UNIX_MISC
extern int	dladdr(void const *__addr, Dl_info *__info);
#endif
#ifdef __EXT_QNX
extern int	_dladdr(void const *__addr, Dl_info *__info);
extern void	*_dlsym(const void *__restrict __handle_arg, const char *__restrict __name);
#endif
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.1.0/trunk/lib/c/public/dlfcn.h $ $Rev: 900762 $")
#endif
