 ...
 * MDSCR bits
 */
#define AARCH64_MDSCR_MDE   (1u << 15)
#define AARCH64_MDSCR_KDE   (1u << 13)
#define AARCH64_MDSCR_SS    (1u << 0)

#endif /* __AARCH64_CPU_H_INCLUDED */

#if defined(__QNXNTO__) && defined(__USESRCVERSION)
#include <sys/srcversion.h>
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.0.0/BC700_6762_sdp704/services/system/public/aarch64/cpu.h $ $Rev: 879645 $") 
#endif
