...
#define __NET_BE16(__x) ENDIAN_RET16(__x)
#define __NET_BE32(__x) ENDIAN_RET32(__x)
#define __NET_BE64(__x) ENDIAN_RET64(__x)

#elif defined(__BIGENDIAN__)

#define __NET_LE16(__x) ENDIAN_RET16(__x)
#define __NET_LE32(__x) ENDIAN_RET32(__x)
#define __NET_LE64(__x) ENDIAN_RET64(__x)
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.1.0/trunk/lib/socket/public/net/netbyte.h $ $Rev: 887542 $")
#endif
