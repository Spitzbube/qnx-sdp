...
struct qdb_function {
	...
	int			narg;
	void		*arg;
	void		(*func)(struct sqlite3_context *, int, struct sqlite3_value **);
	void		(*step)(struct sqlite3_context *, int, struct sqlite3_value **);
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.1.0/trunk/lib/qdb/public/qdb/qdb.h $ $Rev: 854518 $")
#endif
