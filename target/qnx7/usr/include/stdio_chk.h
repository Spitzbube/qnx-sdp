...
#ifdef __bvap
extern __FORTIFY_FUNCTION int sprintf(char *__s, const char *__format, ...) {
  return __builtin___sprintf_chk (__s, __USE_FORTIFY_LEVEL - 1, __bos(__s), __format, __bvap);
}

extern __FORTIFY_FUNCTION int snprintf(char *__s, size_t __size, const char *__format, ...) {
  return __builtin___snprintf_chk (__s, __size, __USE_FORTIFY_LEVEL - 1, __bos(__s), __format, __bvap);
}
#endif

extern __FORTIFY_FUNCTION int vsprintf(char *__s, const char *__format, __NTO_va_list __arg) {
  return __builtin___vsprintf_chk( __s, __USE_FORTIFY_LEVEL - 1, __bos(__s), __format, __arg);
}

extern __FORTIFY_FUNCTION int vsnprintf(char *__s, size_t __size, const char *__format, __NTO_va_list __arg) {
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.1.0/trunk/lib/c/public/stdio_chk.h $ $Rev: 866215 $")
#endif
