...
#define USB_VENDOR_UT					0x2996
	#define USB_PRODUCT_UT_H2H_LOW		0x0100
	#define USB_PRODUCT_UT_H2H_HIGH		0x0109
	#define USB_PRODUCT_UT_H2H_MATCH(X)	( X >= USB_PRODUCT_UT_H2H_LOW && X <= USB_PRODUCT_UT_H2H_HIGH )
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.1.0/trunk/lib/usbdi/public/hw/usb_devices.h $ $Rev: 876507 $")
#endif
