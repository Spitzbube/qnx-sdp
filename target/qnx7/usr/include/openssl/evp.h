...
/* QNX */
const EVP_MD *EVP_blake2b384(void);
const EVP_MD *EVP_blake2b256(void);
const EVP_MD *EVP_blake2b160(void);
/* QNX */
const EVP_MD *EVP_blake2s256(void);
/* QNX */
const EVP_MD *EVP_blake2s224(void);
const EVP_MD *EVP_blake2s160(void);
const EVP_MD *EVP_blake2s128(void);
/* QNX */
# endif
/* QNX */
...
__SRCVERSION("$URL: http://f27svn.qnx.com/svn/repos/osr/branches/7.1.0/trunk/openssl1_1/dist/include/openssl/evp.h $ $Rev: 1687 $")
#endif
