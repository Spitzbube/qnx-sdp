...
extern int twalk_np(const void *__root, void (*__action)(const void *, VISIT, int));
#endif
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.1.0/trunk/lib/c/public/search.h $ $Rev: 872854 $")
#endif
