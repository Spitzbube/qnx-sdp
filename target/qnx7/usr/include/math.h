...
/* ISO C99 5.2.4.2.2 says that value -1 characterizes indeterminable
 * behavior but ICC defines __FLT_EVAL_METHOD__ to -1 and expects
 * double_t and float_t to be defined though */
#elif (__FLT_EVAL_METHOD__-0) == -1
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.0.0/BC700_6762_sdp704/lib/m/lib/public/math.h $ $Rev: 866750 $")
#endif
