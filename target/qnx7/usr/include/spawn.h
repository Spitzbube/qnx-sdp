...
# define POSIX_SPAWN_SETCWD          0x04000000  /* Spawn a child with a custom working directory */
...
# define POSIX_SPAWN_SETASID         0x40000000  /* Assign specific asid to process */
# define POSIX_SPAWN_CRITICAL        0x80000000  /* Mark process as critical */

typedef enum {
	POSIX_SPAWN_ASLR_DEFAULT = 0,
	POSIX_SPAWN_ASLR_ENABLE = 1,
	POSIX_SPAWN_ASLR_DISABLE = 2,
} posix_spawnattr_aslr_t;
...
extern int posix_spawnattr_setasid(posix_spawnattr_t *__attrp, _Uint32t __asid);
extern int posix_spawnattr_getaslr(const posix_spawnattr_t * const __attrp, posix_spawnattr_aslr_t *_Restrict __aslr);
extern int posix_spawnattr_setaslr(posix_spawnattr_t * const __attrp, posix_spawnattr_aslr_t const __aslr);
extern int posix_spawnattr_setcwd_np(posix_spawnattr_t * const __attrp, const int __dirfd);
...
# define SPAWN_CRITICAL          POSIX_SPAWN_CRITICAL
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.1.0/trunk/lib/c/public/spawn.h $ $Rev: 912243 $")
#endif
