...
#define AOCONFIGSETTINGS_VERSION 100
/*
 * AOConfigSettings: interface to provide config settings to addon after it's loaded
 */
typedef struct
{
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.1.0/trunk/lib/aoi/public/aoi/aoi_interfaces.h $ $Rev: 898082 $")
#endif
