...
#ifdef __QNXNTO__
    #define AP_STA_ASSOC_VSE_MISMATCH "AP-STA-ASSOC-MISMATCH"
    #define AP_STA_ASSOC_REQUEST "AP-STA-ASSOC-REQUEST"
#endif  /* __QNXNTO__ */
...
#ifdef __QNXNTO__
/**
 * wpa_ctrl_set_cmd_timeout() - set command timeout for all requests in secs
 * or set to default.
 * int secs: secs <= 0 or > 120 will set to default = 10 otherwise set to secs.
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.1.0/trunk/lib/io-pkt/dist/wpa-2.9/src/common/wpa_ctrl.h $ $Rev: 900379 $")
#endif
