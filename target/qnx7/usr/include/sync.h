...
extern int (spin_init)(spinlock_t *lock);
extern int (spin_destroy)(spinlock_t *lock);
extern int (spin_lock)(spinlock_t *lock);
extern int (spin_trylock)(spinlock_t *lock);
extern int (spin_unlock)(spinlock_t *lock);
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.1.0/trunk/lib/c/public/sync.h $ $Rev: 905347 $")
#endif
