...
extern void *__ldd_register_eh(Ldd_Eh_t eh, void *eh_d_handle, unsigned flags);
/* deregister an event handler */
extern int __ldd_deregister_eh(void *ehh);

extern int dl_iterate_phdr(Dl_Iterate_Phdr_t callback, void *data);
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.1.0/trunk/lib/c/public/sys/link.h $ $Rev: 886062 $")
#endif
