...
typedef struct _iofunc_attr {
    ...
    union {
        ...
        pthread_mutex_t             lock;       /* Attribute lock */
    };
...
#else
	#define _IO_READ_GET_NBYTES(msg) ((_Size64t)(msg)->i.nbytes | (((msg)->i.type == _IO_READ64) ? ((_Size64t)(msg)->i64.nbytes_hi << 32) : 0))
	#define _IO_WRITE_GET_NBYTES(msg) ((_Size64t)(msg)->i.nbytes | (((msg)->i.type == _IO_WRITE64) ? ((_Size64t)(msg)->i64.nbytes_hi << 32) : 0))
#endif
...
extern int iofunc_mmap_default_ext(resmgr_context_t *__ctp, io_mmap_t *__msg, iofunc_ocb_t *__ocb);
...
/* this function has been deprecated, instead of using it, directly validate that a client has proper permissions, on a DCMD by DCMD basis */
...
extern int iofunc_mmap_ext(resmgr_context_t *__ctp, io_mmap_t *__msg, iofunc_ocb_t *__ocb, iofunc_attr_t *__attr,
                           uint32_t const __flags, struct stat const * const __stat_info);
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.1.0/trunk/lib/c/public/sys/iofunc.h $ $Rev: 905333 $")
#endif
