...
#define RPMB_FRAME_SIZE         sizeof(struct rpmb_frame_t)
...
#define	RPMB_READ_RESULT		0x5		/* Read Result Request */
...
#define DCMD_RPMB_CMD			__DIOTF(_DCMD_CAM, _SIM_RPMB + 0, struct _rpmb_cmdhdr)
#define DCMD_RPMB_INFO			__DIOF(_DCMD_CAM, _SIM_RPMB + 1, struct _rpmb_info)
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.0.0/BC700_6762_sdp704/hardware/devb/cam/public/sys/rpmb.h $ $Rev: 856086 $")
#endif
