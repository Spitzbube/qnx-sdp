...
extern void *_resmgr_handle(struct _msg_info_hdr *__rep, void *__handle, enum _resmgr_handle_type __type);
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.0.0/BC700_6762_sdp704/lib/c/public/sys/resmgr.h $ $Rev: 842077 $")
#endif
