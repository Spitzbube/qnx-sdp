...
#define _NTO_IO_LEVEL_NONE		1
#define _NTO_IO_LEVEL_1			2
#define _NTO_IO_LEVEL_2			3
/*
...
#define _NTO_COF_UNREG_EVENTS	0x4000
#define _NTO_COF_MASK           0xffff
...
#define _NTO_INTR_FLAGS_FPU			0x40u  //handler do FPU/SIMD, internal use for now.
...
#define _NTO_KEYDATA_OP_MASK			0xff
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.1.0/trunk/services/system/public/sys/neutrino.h $ $Rev: 911450 $")
#endif
