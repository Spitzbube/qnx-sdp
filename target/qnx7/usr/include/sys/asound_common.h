...
#define		SND_CTL_READ_AUDIOMGMT_STATUS_CHG  130
#define		SND_CTL_EVENT_MASK(x) (1 << (x - SND_CTL_READ_REBUILD))
...
typedef struct snd_ctrl_afm_event
{
	...
	uint8_t reserved[280];  /* must be filled with zero */
...
typedef struct snd_ctl_read_s
{
	...
	union
	{
		...
		struct
		{
			char        output_id[64];      /* Audio management ducking output ID/name */
		}		audiomgmt;
		snd_ctrl_afm_event_t afm;
		uint8_t		reserved[296];      /* must be filled with zero */
	}		data;
	uint8_t		reserved[128];      /* must be filled with zero */
}		snd_ctl_read_t;
...
typedef struct snd_ducking_subchn_info
{
    ...
    uint32_t  prio;          /* Ducking priority level */
    uint32_t  state;         /* Ducking state SND_PCM_DUCKING_STATE_*  */
    uint32_t  ducked_by;
#define SND_PCM_DUCKED_BY_SAME_PRIO    (1<<0)
#define SND_PCM_DUCKED_BY_HIGHER_PRIO  (1<<1)
#define SND_PCM_DUCKED_BY_NONTRANSIENT (1<<2)
    char      name[32];      /* Audio type name     */
}snd_ducking_subchn_info_t;

typedef struct snd_ducking_priority_status {
    int      nsubchns;                    /* Number of subchns at this priority */
    snd_ducking_subchn_info_t subchns[];  /* Variable array of subchn stuctures */
...
#define		SND_CTL_DCMD_DUCKING_STATUS_READ	__DIOTF ('C', 0x67, char)
#define		SND_CTL_IOCTL_GET_FILTER			_IOR ('C', 0x68, snd_ctl_filter_t)
#define		SND_CTL_IOCTL_SET_FILTER			_IOW ('C', 0x69, snd_ctl_filter_t)

typedef struct snd_ctl_filter
{
	uint32_t	enable;             /* bitfield created using SND_CTL_EVENT_MASK() */
...
#define		SND_MIXER_VERSION		SND_PROTOCOL_VERSION('M',3,0,1)
...
#define		SND_MIXER_ETYPE_BALANCE1		215
...
{
	uint32_t		attrib;
	uint32_t		voices, voices_over, voices_size;
...
typedef struct snd_mixer_element_balance1_range
{
	uint32_t min, max;
	uint8_t	 reserved[32];	/* must be filled with zero */
}		snd_mixer_element_balance1_range;

#define SND_MIXER_BALANCE_BALANCE (0x0)
#define SND_MIXER_BALANCE_FADE    (0x1)

typedef struct snd_mixer_element_balance1_info
{
	uint32_t caps;
	struct snd_mixer_element_balance1_range range;
	uint8_t	 	reserved[128];			/* must be filled with zero */
}		snd_mixer_element_balance1_info;

typedef struct snd_mixer_element_balance1
{
	uint32_t	caps;
	uint32_t	balance_level;
	uint32_t	fade_level;
	uint8_t	 	reserved[128];			/* must be filled with zero */
}		snd_mixer_element_balance1;
...
typedef enum
{
	...
	SND_MIXER_CHN_SIDE_LEFT,
	SND_MIXER_CHN_SIDE_RIGHT,
	SND_MIXER_CHN_SURR_LEFT   = SND_MIXER_CHN_SIDE_LEFT,   /* deprecated */
	SND_MIXER_CHN_SURR_RIGHT  = SND_MIXER_CHN_SIDE_RIGHT,  /* deprecated */
	SND_MIXER_CHN_REAR_CENTER,
	SND_MIXER_CHN_FRONT_LEFT_CENTER,
	SND_MIXER_CHN_FRONT_RIGHT_CENTER,
	SND_MIXER_CHN_REAR_LEFT_CENTER,
	SND_MIXER_CHN_REAR_RIGHT_CENTER,
	SND_MIXER_CHN_FRONT_LEFT_WIDE,
	SND_MIXER_CHN_FRONT_RIGHT_WIDE,
	SND_MIXER_CHN_FRONT_LEFT_HIGH,
	SND_MIXER_CHN_FRONT_CENTER_HIGH,
	SND_MIXER_CHN_FRONT_RIGHT_HIGH,
	SND_MIXER_CHN_TOP_CENTER,
	SND_MIXER_CHN_TOP_FRONT_LEFT,
	SND_MIXER_CHN_TOP_FRONT_RIGHT,
	SND_MIXER_CHN_TOP_FRONT_CENTER,
	SND_MIXER_CHN_TOP_REAR_LEFT,
	SND_MIXER_CHN_TOP_REAR_RIGHT,
	SND_MIXER_CHN_TOP_REAR_CENTER,
	SND_MIXER_CHN_TOP_FRONT_LEFT_CENTER,
	SND_MIXER_CHN_TOP_FRONT_RIGHT_CENTER,
	SND_MIXER_CHN_TOP_SIDE_LEFT,
	SND_MIXER_CHN_TOP_SIDE_RIGHT,
	SND_MIXER_CHN_LEFT_LFE,
	SND_MIXER_CHN_RIGHT_LFE,
	SND_MIXER_CHN_BOTTOM_CENTER,
	SND_MIXER_CHN_BOTTOM_LEFT_CENTER,
	SND_MIXER_CHN_BOTTOM_RIGHT_CENTER,
	SND_MIXER_CHN_LAST = SND_MIXER_CHN_BOTTOM_RIGHT_CENTER,
	SND_MIXER_CHN_MAX = 64
}		snd_mixer_channel_t;

#define	SND_MIXER_CHN_MASK_MONO                     (1ULL<<SND_MIXER_CHN_FRONT_LEFT)
#define	SND_MIXER_CHN_MASK_FRONT_LEFT               (1ULL<<SND_MIXER_CHN_FRONT_LEFT)
#define	SND_MIXER_CHN_MASK_FRONT_RIGHT              (1ULL<<SND_MIXER_CHN_FRONT_RIGHT)
#define	SND_MIXER_CHN_MASK_FRONT_CENTER             (1ULL<<SND_MIXER_CHN_FRONT_CENTER)
#define	SND_MIXER_CHN_MASK_REAR_LEFT                (1ULL<<SND_MIXER_CHN_REAR_LEFT)
#define	SND_MIXER_CHN_MASK_REAR_RIGHT               (1ULL<<SND_MIXER_CHN_REAR_RIGHT)
#define	SND_MIXER_CHN_MASK_WOOFER                   (1ULL<<SND_MIXER_CHN_WOOFER)
#define	SND_MIXER_CHN_MASK_SIDE_LEFT                (1ULL<<SND_MIXER_CHN_SIDE_LEFT)
#define	SND_MIXER_CHN_MASK_SIDE_RIGHT               (1ULL<<SND_MIXER_CHN_SIDE_RIGHT)
#define	SND_MIXER_CHN_MASK_SURR_LEFT                (1ULL<<SND_MIXER_CHN_SURR_LEFT)     /* deprecated - use SND_MIXER_CHN_MASK_SIDE_LEFT  */
#define	SND_MIXER_CHN_MASK_SURR_RIGHT               (1ULL<<SND_MIXER_CHN_SURR_RIGHT)    /* deprecated - use SND_MIXER_CHN_MASK_SIDE_RIGHT */
#define	SND_MIXER_CHN_MASK_REAR_CENTER              (1ULL<<SND_MIXER_CHN_REAR_CENTER)
#define	SND_MIXER_CHN_MASK_FRONT_LEFT_CENTER        (1ULL<<SND_MIXER_CHN_FRONT_LEFT_CENTER)
#define	SND_MIXER_CHN_MASK_FRONT_RIGHT_CENTER       (1ULL<<SND_MIXER_CHN_FRONT_RIGHT_CENTER)
#define	SND_MIXER_CHN_MASK_REAR_LEFT_CENTER         (1ULL<<SND_MIXER_CHN_REAR_LEFT_CENTER)
#define	SND_MIXER_CHN_MASK_REAR_RIGHT_CENTER        (1ULL<<SND_MIXER_CHN_REAR_RIGHT_CENTER)
#define	SND_MIXER_CHN_MASK_FRONT_LEFT_WIDE          (1ULL<<SND_MIXER_CHN_FRONT_LEFT_WIDE)
#define	SND_MIXER_CHN_MASK_FRONT_RIGHT_WIDE         (1ULL<<SND_MIXER_CHN_FRONT_RIGHT_WIDE)
#define	SND_MIXER_CHN_MASK_FRONT_LEFT_HIGH          (1ULL<<SND_MIXER_CHN_FRONT_LEFT_HIGH)
#define	SND_MIXER_CHN_MASK_FRONT_CENTER_HIGH        (1ULL<<SND_MIXER_CHN_FRONT_CENTER_HIGH)
#define	SND_MIXER_CHN_MASK_FRONT_RIGHT_HIGH         (1ULL<<SND_MIXER_CHN_FRONT_RIGHT_HIGH)
#define	SND_MIXER_CHN_MASK_TOP_CENTER               (1ULL<<SND_MIXER_CHN_TOP_CENTER)
#define	SND_MIXER_CHN_MASK_TOP_FRONT_LEFT           (1ULL<<SND_MIXER_CHN_TOP_FRONT_LEFT)
#define	SND_MIXER_CHN_MASK_TOP_FRONT_RIGHT          (1ULL<<SND_MIXER_CHN_TOP_FRONT_RIGHT)
#define	SND_MIXER_CHN_MASK_TOP_FRONT_CENTER         (1ULL<<SND_MIXER_CHN_TOP_FRONT_CENTER)
#define	SND_MIXER_CHN_MASK_TOP_REAR_LEFT            (1ULL<<SND_MIXER_CHN_TOP_REAR_LEFT)
#define	SND_MIXER_CHN_MASK_TOP_REAR_RIGHT           (1ULL<<SND_MIXER_CHN_TOP_REAR_RIGHT)
#define	SND_MIXER_CHN_MASK_TOP_REAR_CENTER          (1ULL<<SND_MIXER_CHN_TOP_REAR_CENTER)
#define	SND_MIXER_CHN_MASK_TOP_FRONT_LEFT_CENTER    (1ULL<<SND_MIXER_CHN_TOP_FRONT_LEFT_CENTER)
#define	SND_MIXER_CHN_MASK_TOP_FRONT_RIGHT_CENTER   (1ULL<<SND_MIXER_CHN_TOP_FRONT_RIGHT_CENTER)
#define	SND_MIXER_CHN_MASK_TOP_SIDE_LEFT            (1ULL<<SND_MIXER_CHN_TOP_SIDE_LEFT)
#define	SND_MIXER_CHN_MASK_TOP_SIDE_RIGHT           (1ULL<<SND_MIXER_CHN_TOP_SIDE_RIGHT)
#define	SND_MIXER_CHN_MASK_LEFT_LFE                 (1ULL<<SND_MIXER_CHN_LEFT_LFE)
#define	SND_MIXER_CHN_MASK_RIGHT_LFE                (1ULL<<SND_MIXER_CHN_RIGHT_LFE)
#define	SND_MIXER_CHN_MASK_BOTTOM_CENTER            (1ULL<<SND_MIXER_CHN_BOTTOM_CENTER)
#define	SND_MIXER_CHN_MASK_BOTTOM_LEFT_CENTER       (1ULL<<SND_MIXER_CHN_BOTTOM_LEFT_CENTER)
#define	SND_MIXER_CHN_MASK_BOTTOM_RIGHT_CENTER      (1ULL<<SND_MIXER_CHN_BOTTOM_RIGHT_CENTER)

#define SND_MIXER_CHN_MASK_LEFT     (SND_MIXER_CHN_MASK_FRONT_LEFT |             \
                                     SND_MIXER_CHN_MASK_REAR_LEFT  |             \
                                     SND_MIXER_CHN_MASK_SIDE_LEFT  |             \
                                     SND_MIXER_CHN_MASK_FRONT_LEFT_CENTER |      \
                                     SND_MIXER_CHN_MASK_REAR_LEFT_CENTER |       \
                                     SND_MIXER_CHN_MASK_FRONT_LEFT_WIDE |        \
                                     SND_MIXER_CHN_MASK_FRONT_LEFT_HIGH |        \
                                     SND_MIXER_CHN_MASK_TOP_FRONT_LEFT |         \
                                     SND_MIXER_CHN_MASK_TOP_REAR_LEFT |          \
                                     SND_MIXER_CHN_MASK_TOP_FRONT_LEFT_CENTER |  \
                                     SND_MIXER_CHN_MASK_TOP_SIDE_LEFT |          \
                                     SND_MIXER_CHN_MASK_LEFT_LFE      |          \
                                     SND_MIXER_CHN_MASK_BOTTOM_LEFT_CENTER)

#define SND_MIXER_CHN_MASK_RIGHT    (SND_MIXER_CHN_MASK_FRONT_RIGHT |             \
                                     SND_MIXER_CHN_MASK_REAR_RIGHT  |             \
                                     SND_MIXER_CHN_MASK_SIDE_RIGHT  |             \
                                     SND_MIXER_CHN_MASK_FRONT_RIGHT_CENTER |      \
                                     SND_MIXER_CHN_MASK_REAR_RIGHT_CENTER  |      \
                                     SND_MIXER_CHN_MASK_FRONT_RIGHT_WIDE   |      \
                                     SND_MIXER_CHN_MASK_FRONT_RIGHT_HIGH   |      \
                                     SND_MIXER_CHN_MASK_TOP_FRONT_RIGHT    |      \
                                     SND_MIXER_CHN_MASK_TOP_REAR_RIGHT     |      \
                                     SND_MIXER_CHN_MASK_TOP_FRONT_RIGHT_CENTER |  \
                                     SND_MIXER_CHN_MASK_TOP_SIDE_RIGHT     |      \
                                     SND_MIXER_CHN_MASK_RIGHT_LFE          |      \
                                     SND_MIXER_CHN_MASK_BOTTOM_RIGHT_CENTER)

#define SND_MIXER_CHN_MASK_FRONT    (SND_MIXER_CHN_MASK_FRONT_LEFT   |             \
                                     ...
                                     SND_MIXER_CHN_MASK_FRONT_LEFT_HIGH    |       \
                                     SND_MIXER_CHN_MASK_FRONT_RIGHT_HIGH   |       \
                                     SND_MIXER_CHN_MASK_FRONT_CENTER_HIGH  |       \
                                     SND_MIXER_CHN_MASK_TOP_FRONT_LEFT     |       \
                                     SND_MIXER_CHN_MASK_TOP_FRONT_RIGHT    |       \
                                     SND_MIXER_CHN_MASK_TOP_FRONT_CENTER   |       \
                                     SND_MIXER_CHN_MASK_TOP_FRONT_LEFT_CENTER |    \
                                     SND_MIXER_CHN_MASK_TOP_FRONT_RIGHT_CENTER)

#define SND_MIXER_CHN_MASK_REAR     (SND_MIXER_CHN_MASK_REAR_LEFT   |              \
                                     SND_MIXER_CHN_MASK_REAR_RIGHT  |              \
                                     SND_MIXER_CHN_MASK_REAR_CENTER |              \
                                     SND_MIXER_CHN_MASK_REAR_LEFT_CENTER  |        \
                                     SND_MIXER_CHN_MASK_REAR_RIGHT_CENTER |        \
                                     ...
                                     SND_MIXER_CHN_MASK_TOP_REAR_LEFT     |        \
                                     SND_MIXER_CHN_MASK_TOP_REAR_RIGHT    |        \
                                     SND_MIXER_CHN_MASK_TOP_REAR_CENTER)

#define SND_MIXER_CHN_MASK_ABS_CENTER (SND_MIXER_CHN_MASK_FRONT_CENTER      |      \
                                       SND_MIXER_CHN_MASK_REAR_CENTER       |      \
                                       SND_MIXER_CHN_MASK_FRONT_CENTER_HIGH |      \
                                       SND_MIXER_CHN_MASK_TOP_CENTER        |      \
                                       SND_MIXER_CHN_MASK_TOP_FRONT_CENTER  |      \
                                       SND_MIXER_CHN_MASK_TOP_REAR_CENTER   |      \
                                       SND_MIXER_CHN_MASK_BOTTOM_CENTER)
...
#define	SND_MIXER_CHN_MASK_7_1				(SND_MIXER_CHN_MASK_5_1|SND_MIXER_CHN_MASK_SIDE_LEFT|SND_MIXER_CHN_MASK_SIDE_RIGHT)
...
#define	SND_MIXER_GRPCAP_BALANCE			(1<<26)
#define	SND_MIXER_GRPCAP_FADE				(1<<27)
#define	SND_MIXER_GRPCAP_INTERNAL_RAMP		(1<<28)
...
typedef struct snd_mixer_group_s
{
	...
	int32_t		min_dB, max_dB;			/* min and max dB range values multiplied by dB_scale_factor */
	int32_t		dB_scale_factor;		/* value by which min_dB and max_dB have been scaled */
	uint32_t	balance_min;			/* Balance min */
	uint32_t	balance_max;			/* Balance max */
	uint32_t	balance_level;			/* Balance level */
	uint32_t	fade_level;				/* Fade level */
...
#define		SND_MIXER_EVENT_MASK(x) (1<<x)  /* Use with SND_MIXER_READ_* definitions) */
...
{
	uint32_t	enable;             /* bitfield created using SND_MIXER_EVENT_MASK() */
	uint8_t		reserved[124];      /* must be filled with zero */
}		snd_mixer_filter_t;
...
#define SND_AFM_DCMD_SET_PATH              __DIOT ('S', 0x22, snd_afm_path_t)
#define SND_AFM_DCMD_SET_AUDIO_MODE        __DIOT ('S', 0x23, char)
#define SND_AFM_DCMD_GET_AUDIO_MODE        __DIOF ('S', 0x24, char)
#define SND_AFM_IOCTL_START_LATENCY_TEST   _IOW   ('S', 0x25, snd_afm_latency_test_t)
#define SND_AFM_DCMD_GET_VIN_LIST_COUNT    __DIOF ('S', 0x26, int)
#define SND_AFM_DCMD_GET_VIN_LIST          __DIOF ('S', 0x27, snd_afm_vin_list_item_t)
#define SND_AFM_DCMD_SET_VIN_STREAM        __DIOT ('S', 0x28, snd_afm_vin_pair_t)
#define SND_AFM_DCMD_GET_AP_DATA           __DIOTF('S', 0x29, snd_afm_ap_param_t)
#define SND_AFM_DCMD_SET_AP_DATA           __DIOTF('S', 0x2A, snd_afm_ap_param_t)
#define SND_AFM_DCMD_LOAD_AP_DATASET       __DIOTF('S', 0x2B, int)
#define SND_AFM_IOCTL_INFO                 _IOR   ('S', 0x2C, snd_afm_info_t)
#define SND_AFM_IOCTL_STATUS               _IOR   ('S', 0x2D, snd_afm_status_t)
#define SND_AFM_DCMD_GET_PARAM             __DIOTF('S', 0x2E, int)
#define SND_AFM_DCMD_SET_PARAM             __DIOTF('S', 0x2F, int)
...
#define		SND_PCM_VERSION		SND_PROTOCOL_VERSION('P',3,0,2)
...
#define		SND_PCM_SFMT_U24_4					SND_PCM_SFMT_U24_4_LE
#define		SND_PCM_SFMT_S24_4					SND_PCM_SFMT_S24_4_LE
...
#define		SND_PCM_SFMT_U24_4					SND_PCM_SFMT_U24_4_BE
#define		SND_PCM_SFMT_S24_4					SND_PCM_SFMT_S24_4_BE
...
#define		SND_PCM_FMT_U24_4_LE				(1<<SND_PCM_SFMT_U24_4_LE)
#define		SND_PCM_FMT_U24_4_BE				(1<<SND_PCM_SFMT_U24_4_BE)
#define		SND_PCM_FMT_S24_LE					(1<<SND_PCM_SFMT_S24_LE)
#define		SND_PCM_FMT_S24_BE					(1<<SND_PCM_SFMT_S24_BE)
#define		SND_PCM_FMT_S24_4_LE				(1<<SND_PCM_SFMT_S24_4_LE)
#define		SND_PCM_FMT_S24_4_BE				(1<<SND_PCM_SFMT_S24_4_BE)
...
#define		SND_PCM_FMT_U24_4					SND_PCM_FMT_U24_4_LE
#define		SND_PCM_FMT_S24_4					SND_PCM_FMT_S24_4_LE
...
#define		SND_PCM_FMT_U24_4					SND_PCM_FMT_U24_4_BE
#define		SND_PCM_FMT_S24_4					SND_PCM_FMT_S24_4_BE
...
#define		SND_PCM_RATE_12000				(1<<14)
#define		SND_PCM_RATE_16000				(1<<3)
#define		SND_PCM_RATE_18900				(1<<13)
...
#define		SND_PCM_RATE_64000				(1<<15)
...
#define		SND_PCM_RATE_8000_44100			0x707E
#define		SND_PCM_RATE_8000_48000			0x70FE
#define		SND_PCM_RATE_ALL				0xFFFE


#define		SND_PCM_CHNINFO_BLOCK			0x00001 /* required */
...
#define		SND_PCM_CHNINFO_HW_POSITION		0x08000
...
#define		SND_PCM_PARAMS_BAD_AUDIOTYPE	11
...
#define SND_PCM_MUTE_EVENT_SAME_PRIORITY   (1<<0)
#define SND_PCM_MUTE_EVENT_HIGHER_PRIORITY (1<<1)
...
struct snd_pcm_info
{
	...
	uint32_t	flags;					/* see SND_PCM_INFO_* */
...
typedef struct snd_pcm_channel_info
{
	...
	uint32_t	output_class;			/* output class used for DRM purposes - see SND_OUTPUT_CLASS_* */
	uint32_t	output_classes;			/* mask of supported output classes used for DRM purposes */
	int32_t		zero2[2];				/* filler */
	uint32_t	flags;					/* see to SND_PCM_CHNINFO_* */
...
{
	int32_t				channel;
	int32_t				mode;				/* must include SND_PCM_MODE_BLOCK */
...
typedef struct snd_pcm_channel_setup
{
	...
	uint8_t		mmap_active:1;			/* channel is using mmapped transfers */
...
typedef struct snd_pcm_channel_status
{
	...
	int32_t			status;			/* channel status-SND_PCM_STATUS_* */
	...
	uint32_t		subbuffered;	/* bytes sub buffered in the plugin interface */
	uint32_t		ducking_state;	/* Audio management ducking state */
#define SND_PCM_DUCKING_STATE_INACTIVE          (0x00)   /* Ducking inactive */
#define SND_PCM_DUCKING_STATE_ACTIVE            (1<<0)   /* Ducking active due to stream active */
#define SND_PCM_DUCKING_STATE_HARD_SUSPENDED    (1<<1)   /* Cannot be unsuspended via resume API */
#define SND_PCM_DUCKING_STATE_SOFT_SUSPENDED    (1<<2)   /* Can be unsuspended via resume API */
#define SND_PCM_DUCKING_STATE_PAUSED            (1<<3)   /* status will transition to SND_PCM_STATUS_PAUSED on unsuspended */
#define SND_PCM_DUCKING_STATE_FORCED_ACTIVE     (1<<4)   /* Ducking active due snd_pcm_channel_audio_ducking() API */
#define SND_PCM_DUCKING_STATE_MUTE_BY_HIGHER    (1<<5)
#define SND_PCM_DUCKING_STATE_MUTE_BY_SAME      (1<<6)
#define SND_PCM_DUCKING_STATE_DUCKED            (1<<7)
...
/* APX IDs */
#define SND_APX_SPM 1
#define SND_APX_SFO 2
typedef snd_afm_ap_param_t snd_pcm_apx_param_t;

#define		SND_PCM_IOCTL_PVERSION			_IOR ('A', 0x10, int32_t)
#define		SND_PCM_IOCTL_INFO				_IOR ('A', 0x20, snd_pcm_info_t)
#define		SND_PCM_IOCTL_CHANNEL_DROP		_IO  ('A', 0x30)
#define		SND_PCM_IOCTL_CHANNEL_DRAIN		_IO  ('A', 0x31)
...
#define		SND_PCM_IOCTL_CHANNEL_LINK		_IOW ('A', 0x72, snd_pcm_link_info_t)
#define		SND_PCM_IOCTL_CHANNEL_UNLINK	_IO ('A', 0x73)
#define		SND_PCM_IOCTL_CHANNEL_LINK_TRANSITION	_IO ('A', 0x74)
#define		SND_PCM_IOCTL_CHANNEL_LINK_MODE	_IOW ('A', 0x75, int)
...
#define SND_PCM_DCMD_GET_APX_DATA              __DIOTF ('A', 0x87, snd_pcm_apx_param_t)
#define SND_PCM_DCMD_SET_APX_DATA              __DIOTF ('A', 0x88, snd_pcm_apx_param_t)
#define SND_PCM_IOCTL_SET_APX_EXTERNAL_VOLUME  _IOW    ('A', 0x90, int16_t[32])
#define SND_PCM_IOCTL_SET_APX_USER_VOLUME      _IOW    ('A', 0x91, int16_t)
#define SND_PCM_DCMD_LOAD_APX_DATASET          __DIOTF ('A', 0x92, int)

typedef struct snd_pcm_filter
{
	uint32_t	enable;            /* bitfield created using SND_PCM_EVENT_MASK() */
	uint8_t		reserved[124];     /* must be filled with zero */
} snd_pcm_filter_t;
...
struct snd_rawmidi_info
{
	...
	uint32_t	flags;			/* see SND_RAWMIDI_INFO_* */
...
#define		SND_RAWMIDI_IOCTL_CHANNEL_DROP		_IOW ('W', 0x50, int)
#define		SND_RAWMIDI_IOCTL_CHANNEL_DRAIN		_IOW ('W', 0x51, int)
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.1.0/trunk/lib/asound/public/include/sys/asound_common.h $ $Rev: 908394 $")
#endif
