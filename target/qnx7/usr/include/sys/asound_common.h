...
#define		SND_CTL_READ_AUDIOMGMT_CHG	125
...
typedef struct snd_ducking_type_status {
    ...
    int prio;        /* Audio type priority */
    int npids;       /* Number of process with active streams with this audio type */
    pid_t pids[1];   /* Array of pids */
} snd_ducking_type_status_t;

typedef struct snd_ducking_output_status {
    int       ntypes;                          /* Number of active audio types */
    snd_ducking_type_status_t active_types[1]; /* Array of active audio types */
#define SND_DUCKING_STATUS_NEXT_TYPE(type) ((void*)type + sizeof(*type) + (sizeof(type->pids[0]) * (type->npids - 1)))
...
#define		SND_CTL_DCMD_READ_DUCKING_STATUS	__DIOTF ('C', 0x66, char)
...
typedef enum
{
	...
	SND_MIXER_CHN_LAST = SND_MIXER_CHN_RIGHT_LFE,
	SND_MIXER_CHN_MAX = 32
}		snd_mixer_channel_t;
...
#define	SND_MIXER_CHN_MASK_SIDE_LEFT                (1<<SND_MIXER_CHN_SIDE_LEFT)
#define	SND_MIXER_CHN_MASK_SIDE_RIGHT               (1<<SND_MIXER_CHN_SIDE_RIGHT)
#define	SND_MIXER_CHN_MASK_SURR_LEFT                (1<<SND_MIXER_CHN_SURR_LEFT)	/* deprecated - use SND_MIXER_CHN_MASK_SIDE_LEFT  */
#define	SND_MIXER_CHN_MASK_SURR_RIGHT               (1<<SND_MIXER_CHN_SURR_RIGHT)	/* deprecated - use SND_MIXER_CHN_MASK_SIDE_RIGHT */
#define	SND_MIXER_CHN_MASK_REAR_CENTER              (1<<SND_MIXER_CHN_REAR_CENTER)
#define	SND_MIXER_CHN_MASK_FRONT_LEFT_CENTER        (1<<SND_MIXER_CHN_FRONT_LEFT_CENTER)
#define	SND_MIXER_CHN_MASK_FRONT_RIGHT_CENTER       (1<<SND_MIXER_CHN_FRONT_RIGHT_CENTER)
#define	SND_MIXER_CHN_MASK_REAR_LEFT_CENTER         (1<<SND_MIXER_CHN_REAR_LEFT_CENTER)
#define	SND_MIXER_CHN_MASK_REAR_RIGHT_CENTER        (1<<SND_MIXER_CHN_REAR_RIGHT_CENTER)
#define	SND_MIXER_CHN_MASK_FRONT_LEFT_WIDE          (1<<SND_MIXER_CHN_FRONT_LEFT_WIDE)
#define	SND_MIXER_CHN_MASK_FRONT_RIGHT_WIDE         (1<<SND_MIXER_CHN_FRONT_RIGHT_WIDE)
#define	SND_MIXER_CHN_MASK_FRONT_LEFT_HIGH          (1<<SND_MIXER_CHN_FRONT_LEFT_HIGH)
#define	SND_MIXER_CHN_MASK_FRONT_CENTER_HIGH        (1<<SND_MIXER_CHN_FRONT_CENTER_HIGH)
#define	SND_MIXER_CHN_MASK_FRONT_RIGHT_HIGH         (1<<SND_MIXER_CHN_FRONT_RIGHT_HIGH)
#define	SND_MIXER_CHN_MASK_TOP_CENTER               (1<<SND_MIXER_CHN_TOP_CENTER)
#define	SND_MIXER_CHN_MASK_TOP_FRONT_LEFT           (1<<SND_MIXER_CHN_TOP_FRONT_LEFT)
#define	SND_MIXER_CHN_MASK_TOP_FRONT_RIGHT          (1<<SND_MIXER_CHN_TOP_FRONT_RIGHT)
#define	SND_MIXER_CHN_MASK_TOP_FRONT_CENTER         (1<<SND_MIXER_CHN_TOP_FRONT_CENTER)
#define	SND_MIXER_CHN_MASK_TOP_REAR_LEFT            (1<<SND_MIXER_CHN_TOP_REAR_LEFT)
#define	SND_MIXER_CHN_MASK_TOP_REAR_RIGHT           (1<<SND_MIXER_CHN_TOP_REAR_RIGHT)
#define	SND_MIXER_CHN_MASK_TOP_REAR_CENTER          (1<<SND_MIXER_CHN_TOP_REAR_CENTER)
#define	SND_MIXER_CHN_MASK_TOP_FRONT_LEFT_CENTER    (1<<SND_MIXER_CHN_TOP_FRONT_LEFT_CENTER)
#define	SND_MIXER_CHN_MASK_TOP_FRONT_RIGHT_CENTER   (1<<SND_MIXER_CHN_TOP_FRONT_RIGHT_CENTER)
#define	SND_MIXER_CHN_MASK_TOP_SIDE_LEFT            (1<<SND_MIXER_CHN_TOP_SIDE_LEFT)
#define	SND_MIXER_CHN_MASK_TOP_SIDE_RIGHT           (1<<SND_MIXER_CHN_TOP_SIDE_RIGHT)
#define	SND_MIXER_CHN_MASK_LEFT_LFE                 (1<<SND_MIXER_CHN_LEFT_LFE)
#define	SND_MIXER_CHN_MASK_RIGHT_LFE                (1<<SND_MIXER_CHN_RIGHT_LFE)
...
#define		SND_PCM_VERSION		SND_PROTOCOL_VERSION('P',3,0,1)
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.0.0/BC700_6762_sdp704/lib/asound/public/include/sys/asound_common.h $ $Rev: 885778 $")
#endif
