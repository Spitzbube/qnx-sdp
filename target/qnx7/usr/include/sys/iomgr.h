...
enum _mgr_types {
	...
	_IOMGR_SMMU = 0x17,					/* System MMU manager */
	_IOMGR_TABRM = 0x18,				/* TPM Access Broker and (TCG) Resource Manager */
	_IOMGR_KEYSTORE = 0x19,				/* Keystore Manager */
	_IOMGR_QFIM = 0x1A,					/* QFIM (integrity measurement) daemon */
	_IOMGR_DEVCRYPTO = 0x20,			/* /dev/crypto (devcr) Manager */
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.1.0/trunk/lib/c/public/sys/iomgr.h $ $Rev: 877412 $")
#endif
