...
#define RLIMIT_SIGEVENT_NP 12   /* maximum number of registered events */
#define RLIMIT_TIMERS_NP  13    /* maximum number of timers created by a process*/
...
#ifdef __EXT_LF64SRC
struct rlimit64;
extern int  getrlimit64(int __resource, struct rlimit64 *__rlp) __ALIASOFF("getrlimit");
extern int  setrlimit64(int __resource, const struct rlimit64 *__rlp) __ALIASOFF("setrlimit");
extern int  prlimit64(pid_t __pid, int __resource, const struct rlimit64 * const __new_rlp, struct rlimit64 * const __old_rlp) __ALIASOFF("prlimit");
#if defined(__EXT_LF64ALIAS) && !defined(__ALIAS_ATTRIBUTE)
#error ALIAS not configured for compiler: getrlimit,setrlimit,prlimit
#endif
#endif

extern int  getrlimit(int __resource, struct rlimit *__rlp) __ALIAS64("getrlimit64");
extern int  setrlimit(int __resource, const struct rlimit *__rlp) __ALIAS64("setrlimit64");
extern int  prlimit(pid_t __pid, int __resource, const struct rlimit * const __new_rlp, struct rlimit * const __old_rlp) __ALIAS64("prlimit64");
...
static __inline int __attribute__((__unused__)) prlimit(pid_t __p, int __t, const struct rlimit *__r1, struct rlimit *__r2) {
	return prlimit64(__p, __t, (const struct rlimit64 *)__r1, (struct rlimit64 *)__r2);
}
#endif
#endif
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.1.0/trunk/lib/c/public/sys/resource.h $ $Rev: 878119 $")
#endif
