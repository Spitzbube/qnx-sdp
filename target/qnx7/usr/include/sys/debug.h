...
typedef struct _debug_process_info {
	...
	_Uint8t						crit_proc;		/* non-zero if critical process */
	_Uint8t						reserved2[6];
	_Uint8t						extsched[8];
...
typedef struct _debug_thread_info32 {
	...
	union {
		...
		struct {
			...
			_Int32t						chid;
			_Int32t						scoid;
			_Uint32t           flags; /* BLOCKED_CONNECT_FLAGS_* */
		}							connect;
		struct {
			_Int32t						chid;
		}							channel;
...
enum {
	...
	REGSET_ALTREGS		= 0x2,
	REGSET_PERFREGS		= 0x3,
	REGSET_STARTCPU		= 0x4000,
	REGSET_STARTPRIV	= 0x8000
};

typedef struct _debug_aspace {
    _Uint64t    as_size;
    _Uint64t    as_used;
    _Uint64t    map_count;
    _Uint64t    map_private;
    _Uint64t    map_shared;
    _Uint64t    rss;
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.1.0/trunk/services/system/public/sys/debug.h $ $Rev: 890371 $")
#endif
