...
#define FLAG_NONROOT			0x40	/* ignore root privileges */
#define FLAG_UNATTENDED		0x80 /* don't ask for options */
#define FLAG_NO_DAEMON		0x100 /* Don't daemonize process.*/
#define FLAG_REVERSE_ORDER		0x200 /* kill processes in reverse order based on creation time */
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.0.0/trunk/lib/shutdown/public/sys/shutdown.h $ $Rev: 836073 $")
#endif
