...
/* 
 * USB_VERSION - versions the interface between libusbd[c]i and the server.  "vusb" 
 * should originate from inside usbd[c]i and not be coming from the client.
 */
#define USB_VERSION				0x0111
...
#define	USB_SUPER_SPEED_PLUS			4

#define USB_SS_DESC_TO_NSTREAMS( ss_endp ) ( 1 << ( *ss_endp->bmAttributes & 0x1F ) )
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.1.0/trunk/lib/usbdi/public/sys/usb100.h $ $Rev: 912097 $")
#endif
