...
/** channel positions */
typedef enum snd_pcm_chmap_position {
...
typedef struct snd_pcm_chmap {
	...
	snd_pcm_chmap_position_t pos[]; /** channel position array */
} snd_pcm_chmap_t;
...
__SRCVERSION( "$URL: http://svn.ott.qnx.com/product/branches/7.1.0/trunk/lib/asound/public/include/sys/asound.h $ $Rev: 893027 $" )
#endif
