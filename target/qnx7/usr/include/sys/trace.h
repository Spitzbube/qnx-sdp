...
#define _NTO_TRACE_SYS_LAST		    _NTO_TRACE_SYS_SCHED_CONF
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.1.0/trunk/services/system/public/sys/trace.h $ $Rev: 895907 $")
#endif
