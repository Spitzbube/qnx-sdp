/*
 * $QNXLicenseC:
 * Copyright 2007, 2009, 2019, QNX Software Systems. All Rights Reserved.
 *
...
#define _NAME_FLAG_COF_INSECURE		(_NTO_COF_INSECURE    << _NAME_FLAG_COF_SHIFT)
#define _NAME_FLAG_COF_NOEVENT		(_NTO_COF_NOEVENT     << _NAME_FLAG_COF_SHIFT)
#define _NAME_FLAG_COF_REG_EVENTS	(_NTO_COF_REG_EVENTS  << _NAME_FLAG_COF_SHIFT)
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.1.0/trunk/lib/c/public/sys/dispatch.h $ $Rev: 913603 $")
#endif
