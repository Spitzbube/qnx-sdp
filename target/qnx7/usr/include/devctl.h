...
#define __DIO_RAW(__class, __cmd, __size, __dir) (int)(((unsigned)(__size)<<16) + ((unsigned)(__class)<<8) + (unsigned)(__cmd) + (unsigned)(__dir))
#define __DIOF(class, cmd, data)	(int)((unsigned)(sizeof(data)<<16) + ((unsigned)(class)<<8) + (unsigned)(cmd) + (unsigned)(_POSIX_DEVDIR_FROM))
#define __DIOT(class, cmd, data)	(int)((unsigned)(sizeof(data)<<16) + ((unsigned)(class)<<8) + (unsigned)(cmd) + (unsigned)(_POSIX_DEVDIR_TO))
#define __DIOTF(class, cmd, data)	(int)((unsigned)(sizeof(data)<<16) + ((unsigned)(class)<<8) + (unsigned)(cmd) + (unsigned)(_POSIX_DEVDIR_TOFROM))

#define __DION(class, cmd)			(int)(((unsigned)(class)<<8) + (unsigned)(cmd) + (unsigned)(_POSIX_DEVDIR_NONE))
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.0.0/BC700_6762_sdp704/lib/c/public/devctl.h $ $Rev: 890330 $")
#endif
