 ...
 * 2^47.. 2^64-2^47-1 are invalid, and cause GP-FAULTs if referenced.
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.1.0/trunk/services/system/public/x86_64/cpu.h $ $Rev: 884216 $")
#endif
