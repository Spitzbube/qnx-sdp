...
#define	ARM_SHMCTL_DEV		0x004u	/* device                 (uncached) */
...
/*
 * If the memory type is Strongly-ordered, or the memory type is Device and
 * the processor implements LPAE, then the region is Shareable. Otherwise,
 * the shareability is determined by ARM_SHMCTL_SH.
 */
#define	ARM_SHMCTL_SH		0x400u	/* shareable */
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.1.0/trunk/services/system/public/arm/mmu.h $ $Rev: 887081 $")
#endif
