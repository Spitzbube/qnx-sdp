...
typedef volatile const uint64_t	cap_msix_pba_t;
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/pci/mainline/modules/capabilities/public/pci/cap_msix.h $ $Rev: 906288 $")
#endif
