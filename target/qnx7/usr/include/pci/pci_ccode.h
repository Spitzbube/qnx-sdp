...
#define PCI_CCODE_STORAGE_SSD_NVMe_IO		PCI_CCODE(PCI_CCODE_STORAGE, PCI_CCODE_STORAGE_SUBCLASS_SSD, 0x02)
#define PCI_CCODE_STORAGE_SSD_NVMe_ADM		PCI_CCODE(PCI_CCODE_STORAGE, PCI_CCODE_STORAGE_SUBCLASS_SSD, 0x03)
/* for backward compatibility, retain this original define */
#define PCI_CCODE_STORAGE_SSD_NVMe			PCI_CCODE_STORAGE_SSD_NVMe_IO
...
#define PCI_CCODE_NET_HOST_FABRIC_VEND_IF	PCI_CCODE(PCI_CCODE_NET, 0x08, 0x00)
...
#define PCI_CCODE_MMEDIA_HDA1_0				PCI_CCODE(PCI_CCODE_MMEDIA, 0x03, 0x00)
#define PCI_CCODE_MMEDIA_HDA1_0_VEND_IF		PCI_CCODE(PCI_CCODE_MMEDIA, 0x03, 0x80)
#define PCI_CCODE_MMEDIA_MIXED_MODE			PCI_CCODE_MMEDIA_HDA1_0	/* preserve previous description */
...
#define PCI_CCODE_SBUS_MIPI_I3C				PCI_CCODE(PCI_CCODE_SBUS, 0x0A, 0x00)
...
#define PCI_CCODE_WIRELESS_CELL_MODEM		PCI_CCODE(PCI_CCODE_WIRELESS, 0x40, 0x00)
#define PCI_CCODE_WIRELESS_CELL_MODEM_ENET	PCI_CCODE(PCI_CCODE_WIRELESS, 0x41, 0x00)
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/pci/mainline/lib/public/pci/pci_ccode.h $ $Rev: 878845 $")
#endif
