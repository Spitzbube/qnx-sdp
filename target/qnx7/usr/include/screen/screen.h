...
*           on a target that's running Screen versio 1.0.0.).
*/
...
enum {
	...
	*/
	...
	/** A single integer in the range @c [-255, 255] that's used to adjust the
	...
	*/
	...
	/** A single integer in the range @c [-128, 127] that is used to adjust the
	...
	*/
	...
	/** A single integer in the range @c [-128, 127] that is used to adjust the hue.
	*   When retrieving or setting this property type, ensure that you have
	*   sufficient storage for one integer.
	...
	*/
	...
	/** A single integer in the range @c [-128, 127] that is used to adjust the saturation.
	*   When retrieving or setting this property type, ensure that you have sufficient storage for
	*   one integer.
	...
	*/
	...
	/** A pair of integers, each in the range @c [0, SHRT_MAX], that define the width and height,
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/graphics/branches/release-3.x.x/lib/screen/public/screen/screen.h $ $Rev: 903921 $")
#endif
