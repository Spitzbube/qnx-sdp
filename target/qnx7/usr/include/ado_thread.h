...
/* thread.c */
int ado_thread_create( pthread_t *thr, int priority, int detachstate, void *(*start_routine)(void *), void *arg);
...
void ado_set_thread_name(const char*func, const char*name);
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.0.0/BC700_6762_sdp704/services/audio/public/include/ado_thread.h $ $Rev: 878045 $")
#endif
