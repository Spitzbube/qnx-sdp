...
/**
* @brief  Enable(1) or disable(0) debug. Default is 0.
*
*          Read/Write @c uint32_t
*/
...
/**
* @brief  set i2c device speed in Hz.
*
*         Read/Write @c uint32_t
*/
#define CAPTURE_PROPERTY_DECODER_I2C_SPEED	CAPTURE_PROPERTY('Q','D','I','S')
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/graphics/branches/release-2.1.x/lib/capture/public/vcapture/capture.h $ $Rev: 876465 $")
#endif
