...
#define ado_error_fmt(...) ado_error_new( __func__, __LINE__, __VA_ARGS__)
#define ado_debug(lvl, ...) (global_options.db_lvl & lvl) ? ado_error_fmt(__VA_ARGS__) : ((void)0)
...
void ado_error_new ( const char *func, const int line, const char *format , ...);
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.0.0/BC700_6762_sdp704/services/audio/public/include/ado_debug.h $ $Rev: 861260 $")
#endif
